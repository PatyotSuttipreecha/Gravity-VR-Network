...
namespace TowerDefenseMP
{
    ...
    /// </summary>
    public class Pool : MonoBehaviour, INetworkPrefabInstanceHandler
    {
        /// <summary>
        ...
        public void Awake()
        {
            ...
            if (netObj && NetworkManager.Singleton.IsServer && !netObj.IsSpawned)
            {
                netObj.Spawn(true);
            }
        ...
        //interface implementation, method called by Unity Networking's spawning system on Network.Spawn
        public NetworkObject Instantiate(ulong ownerClientId, Vector3 position, Quaternion rotation)
        {
            return OnSpawn(position, rotation);
        }

       
        NetworkObject OnSpawn(Vector3 position, Quaternion rotation)
        {
            //just call our regular spawn method
            return Spawn(position, rotation).GetComponent<NetworkObject>();
        }
        ...
        //interface implementation, called by Unity Networking's spawning system
        public void Destroy(NetworkObject networkObject)
        {
            //nothing to do here, we already handle this in our PoolManager
        }


        /// <summary>
        /// Despawn method overload with NetworkObject parameter.
        /// </summary>
